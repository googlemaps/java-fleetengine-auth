...
public class WritingAuthorizationHeaderException extends RuntimeException {
  ...
  /**
   * Constructs a {@code WritingAuthorizationHeaderException} with the specified detail message.
   *
   ...
   */
  public WritingAuthorizationHeaderException(String message, Throwable cause) {
    super(message, cause);
  }
}
