...
/**
 * Signals that an exception occurred while signing a Fleet Engine signer is being initialized.
 *
 * @see Signer
 */
public class SignerInitializationException extends Exception {
  /**
   * Constructs a {@code SignerInitializationException} with the specified detail message.
   *
