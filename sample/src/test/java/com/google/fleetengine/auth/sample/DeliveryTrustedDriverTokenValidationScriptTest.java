...
public class DeliveryTrustedDriverTokenValidationScriptTest {
  ...
  public void run_callsGetDeliveryVehicle_withDeliveryVehicleId() throws Throwable {
    DeliveryTrustedDriverTokenValidationScript script =
        new DeliveryTrustedDriverTokenValidationScript(runtime, configuration, commandsFactory);
